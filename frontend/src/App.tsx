...
function PrivateRoute({ children }: { children: React.ReactNode }) {
  ...
  if (!hydrated) {
    return (
      <div
        className="min-h-screen flex flex-col items-center justify-center gap-3 bg-[var(--app-shell-loading-bg)] text-[var(--app-shell-loading-text)]"
        data-oid="b8l-hkn"
      >
        <Spinner size="lg" data-oid="vm-7n8m" />
        <span data-oid="s6pz50n">Loading...</span>
      </div>
    );
  }
  return isAuthenticated ? (
    ...
    <Navigate to="/login" replace data-oid="63ohbxq" />
  );
}
    ...
    <Suspense
      fallback={
        <div
          ...
          data-oid="scnzjko"
        >
          <Spinner size="lg" data-oid="se5bxmm" />
          <span data-oid="ryatupl">Loading...</span>
        </div>
      }
      data-oid="4j1efh6"
    >
...
function App() {
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      const pad = isDesktop
        ? 0
        : Math.round(Math.min(16, Math.max(8, w * 0.02)));
  ...
  const handleDevtoolsPointerDown = (
  ...
  return (
    <QueryClientProvider client={queryClient} data-oid="pvpw-gm">
      <BrowserCompatibilityWarning data-oid="_61fzzm" />
      <ErrorBoundary data-oid="1vjwxc8">
        <BrowserRouter data-oid="0zraj3m">
          <Routes data-oid="8b6tnvs">
            <Route
              path="/login"
              element={
                <LazyRoute data-oid="iak:kj-">
                  <Login data-oid="d_u40g3" />
                </LazyRoute>
              }
              data-oid="_xydinb"
            />
            ...
            <Route
              path="/register"
              element={
                <LazyRoute data-oid="ys.jcda">
                  <Register data-oid="03ruyqa" />
                </LazyRoute>
              }
              data-oid="nkjp.i8"
            />
            ...
            <Route
              ...
              element={
                <LazyRoute data-oid="6pgmi.h">
                  <GithubCallback data-oid="ljv006l" />
                </LazyRoute>
              }
              data-oid="lqnc1gw"
            />
            ...
            <Route
              path="/share/:token"
              element={
                <LazyRoute data-oid="1-3n5yi">
                  <Share data-oid="1hmz.5j" />
                </LazyRoute>
              }
              data-oid="0og7058"
            />
            ...
            <Route
              path="/files"
              element={
                <PrivateRoute data-oid="rsjlewi">
                  <LazyRoute data-oid="w7ks9v-">
                    <Files data-oid="4slrsm6" />
                  </LazyRoute>
                </PrivateRoute>
              }
              data-oid="bfgl2ti"
            ...
            <Route
              path="/settings"
              element={
                <PrivateRoute data-oid="ehs2p7g">
                  <LazyRoute data-oid="8ed6v2n">
                    <Settings data-oid="2lfreab" />
                  </LazyRoute>
                </PrivateRoute>
              }
              data-oid="plsbqf:"
            ...
            <Route
              path="*"
              element={<Navigate to="/files" replace data-oid="x0o.slg" />}
              data-oid="k4pmtza"
            />
          </Routes>
        </BrowserRouter>
      ...
      {ReactQueryDevtoolsPanel && (
        <Suspense fallback={null} data-oid="nzh557c">
          {devtoolsOpen && (
            <div
            ...
            >
              <div
                className="flex h-full w-full items-center justify-center overflow-hidden sm:items-end sm:justify-end"
                data-oid="531:9et"
              >
                <div
                  className="relative"
      ...
      {ReactQueryDevtoolsPanel && (
        ...
        >
          <span
            className="pointer-events-none absolute inset-0 bg-gradient-to-br from-fuchsia-500/25 via-white/5 to-cyan-400/25 opacity-80 transition-opacity group-hover:opacity-100"
            data-oid="wj5r6k9"
          />

          <span
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(255,255,255,0.35),transparent_55%)] opacity-70"
            data-oid="ti5wwv."
          />
