    ...
    >
        ...
        <div className="ocrRefreshStatusSlot [container-type:inline-size] w-full md:col-start-4">
          <button
            ...
            className={settingsPrimaryButtonClass(
              "ocrRefreshStatusButton ocrStatusFlatButton ocrStatusFlatButton--green inline-flex w-full items-center justify-center gap-[clamp(0.39rem,0.9vw,0.5rem)] whitespace-nowrap shadow-none hover:translate-y-0 active:translate-y-0 active:shadow-none",
            )}
            disabled={isFetching}
            aria-label={
      ...
      >
        ...
        <pre
          ...
          className="mt-[clamp(0.78rem,1.8vw,1rem)] max-w-full overflow-x-auto rounded-[clamp(0.7rem,1.6vw,0.75rem)] border border-[var(--settings-panel-border)] [background:var(--settings-form-input-bg)] p-[clamp(0.78rem,1.8vw,1rem)] text-[length:var(--settings-text-xs)] text-[var(--settings-panel-value)] shadow-[var(--settings-form-input-shadow)]"
        >
        ...
        <ol className="mt-[clamp(0.78rem,1.8vw,1rem)] grid gap-[clamp(0.39rem,0.9vw,0.5rem)] text-[length:var(--settings-text-xs)] leading-relaxed text-[var(--settings-subtitle)]">
          ...
          <li>2. Keep the OCR env block in backend/.env if you override search settings locally.</li>
...
function StatusTile({
  ...
  return (
    <div
      data-testid={testId}
      className="ocrStatusTile ocrStatusFlatTile min-w-0 [container-type:inline-size] rounded-[clamp(0.7rem,1.6vw,0.75rem)] border border-[var(--settings-kpi-border)] [background:var(--settings-kpi-bg)] p-[clamp(0.78rem,1.8vw,1rem)] shadow-none"
    >
