...
const variantConfig = {
  danger: {
    ...
    buttonBg:
      "bg-[var(--confirm-danger-button-bg)] hover:bg-[var(--confirm-danger-button-bg-hover)]",
  ...
  warning: {
    ...
    buttonBg:
      "bg-[var(--confirm-warning-button-bg)] hover:bg-[var(--confirm-warning-button-bg-hover)]",
  ...
  info: {
    ...
    buttonBg:
      "bg-[var(--confirm-info-button-bg)] hover:bg-[var(--confirm-info-button-bg-hover)]",
...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute inset-0 animate-in fade-in duration-150 bg-[var(--confirm-backdrop)]",
        )}
          ...
          <div className="px-[clamp(0.78rem,1.8vw,1rem)] pb-[clamp(0.78rem,1.8vw,1rem)]" data-oid="e0uht7g">
            ...
            >
              ...
              <button
                ...
                disabled={loading}
                className={cn(
                  "neu-semantic-raised flex-1 rounded-[clamp(0.4rem,1vw,0.5rem)] px-[clamp(0.78rem,1.8vw,1rem)] py-[clamp(0.39rem,0.9vw,0.5rem)] text-[clamp(0.75rem,1.8vw,0.875rem)] font-medium text-[var(--confirm-title-text)] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)] active:shadow-[var(--neu-pressed-shadow)]",
                  config.buttonBg,
