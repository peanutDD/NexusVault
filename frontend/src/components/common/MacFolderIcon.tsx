...
export const MacFolderIcon = memo(function MacFolderIcon({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={gTop} x1="3" y1="6" x2="21" y2="6" gradientUnits="userSpaceOnUse">
          <stop stopColor="#A5F3FC" stopOpacity="0.95" />
          <stop offset="1" stopColor="#60A5FA" stopOpacity="0.95" />
        </linearGradient>
        <linearGradient id={gBase} x1="3" y1="10" x2="21" y2="20" gradientUnits="userSpaceOnUse">
          <stop stopColor="#7DD3FC" stopOpacity="0.95" />
          <stop offset="1" stopColor="#2563EB" stopOpacity="0.95" />
        </linearGradient>
        <radialGradient id={gHi} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(7 9) rotate(35) scale(10 6)">
