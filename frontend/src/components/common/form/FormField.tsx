...
const inputBase =
  "neu-inset w-full rounded-[clamp(0.4rem,1vw,0.5rem)] px-[clamp(0.625rem,1.5vw,0.75rem)] py-[clamp(0.4rem,1vw,0.5rem)] text-[var(--control-input-text)] placeholder:text-[var(--control-input-placeholder)] focus:outline-none focus:ring-2 focus:ring-[var(--control-input-ring)] disabled:opacity-50";
