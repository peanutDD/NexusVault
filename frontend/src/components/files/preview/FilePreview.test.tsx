...
describe("FilePreview", () => {
  ...
  it("maps the preview file info card to neuromorphic raised and inset primitives", () => {
    ...
    expect(css).toContain(
      '.neuromorphic-style .previewFileInfoCard',
    );
    expect(css).toContain(
      '.neuromorphic-style .previewFileInfoTitle',
    );
    expect(css).toContain(
      '.neuromorphic-style .previewFileInfoMetaCapsule',
    );
    ...
    expect(css).toContain("color: var(--preview-file-info-size)");
  });
  ...
  it("uses a centered title with all metadata inside one neuromorphic capsule", () => {
    ...
    expect(css).toContain('.neuromorphic-style .previewFileInfoContent');
    expect(css).toContain("flex-direction: column");
    expect(css).toContain("align-items: center");
    expect(css).toContain("justify-content: center");
    expect(css).toContain("text-align: center");
    expect(css).toContain('.neuromorphic-style .previewFileInfoNameBlock');
    expect(css).toContain('.neuromorphic-style .previewFileInfoMetaRail');
    expect(css).toContain('.neuromorphic-style .previewFileInfoMetaCapsule');
    ...
    expect(css).toContain("color: var(--preview-file-info-title)");
    expect(css).toContain("color: var(--preview-file-info-size)");
    expect(css).toContain("color: var(--preview-file-info-type)");
    expect(css).toContain("color: var(--preview-file-info-date)");
    expect(css).not.toContain('.neuromorphic-style .previewFileInfoMetaChip');
    ...
    expect(css).not.toContain("box-shadow: var(--neu-pressed-shadow)");
  });
  ...
  it("removes residual glass borders around neuromorphic preview controls", () => {
    const css = readFileSync(resolve(__dirname, "../../../styles/preview.css"), "utf8")
      .replace(/\s+/g, " ");

    expect(css).toContain('.neuromorphic-style .previewFloatingToolbar');
    expect(css).toContain('.neuromorphic-style .previewNavButton');
    expect(css).toContain('.neuromorphic-style .previewFloatingBtn');
    expect(css).toContain("border: 0 !important");
    expect(css).toContain("backdrop-filter: none !important");
    expect(css).toContain("-webkit-backdrop-filter: none !important");
    expect(css).toContain("box-shadow: var(--neu-control-shadow) !important");
