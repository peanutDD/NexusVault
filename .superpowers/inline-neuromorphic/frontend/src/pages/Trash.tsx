...
function getRetentionState(value?: string | null, now = Date.now()) {
  ...
  const daysLeft = Math.max(
    0,
    Math.ceil((RETENTION_MS - elapsed) / ONE_DAY_MS),
  );
...
function TrashThumbnail({ file }: { file: FileMetadata }) {
  ...
  return (
    <div className="neu-inset flex h-full w-full flex-col items-center justify-center gap-[clamp(0.25rem,0.8vw,0.65rem)] text-[var(--trash-placeholder-icon)]">
...
export default function Trash() {
  ...
  const files = useMemo(
    () =>
      (data?.files ?? EMPTY_FILES).filter(
        (file) => !restoredIdSet.has(file.id),
      ),
  ...
  const restoreMutation = useMutation({
    ...
    onSuccess: (_file, fileId) => {
      ...
      queryClient.setQueryData<{ files: FileMetadata[] }>(
        ["trash"],
        (current) =>
          current
            ? {
  ...
  return (
    ...
    >
      <div
        className="fileListGlassScope space-y-[clamp(0.6rem,1.4vw,0.75rem)] sm:space-y-[clamp(0.75rem,2vw,1rem)]"
        data-testid="trash-shell"
      >
        <div
          data-testid="trash-console"
          className="neu-raised fileListToolbarScale75 trashConsoleToolbar sticky top-[calc(clamp(4.75rem,7.6vw,6.25rem)+env(safe-area-inset-top)+0.75rem)] z-30 p-[clamp(0.6rem,1.4vw,0.75rem)]"
        >
          <div
            data-testid="trash-console-inner"
            className="trashConsoleInner relative flex flex-col gap-[clamp(0.68rem,1.55vw,0.95rem)]"
          >
            <div
            ...
            >
              ...
              <span
                ...
                className="neu-raised-green trashConsoleSummaryChip trashConsoleCountChip flex items-center justify-center leading-none rounded-[clamp(0.35rem,0.8vw,0.5rem)] border-0 px-[clamp(0.42rem,0.9vw,0.62rem)] py-[clamp(0.14rem,0.36vw,0.24rem)] text-[length:var(--font-size-ui-6xs)] font-semibold tracking-[0.12em] text-[var(--filelist-btn-text)] sm:text-[length:var(--font-size-ui-3xs)]"
              >
                {files.length} files
              </span>
              <span
              ...
              >
                <ShieldCheck
                  className="h-[clamp(0.65rem,1.5vw,0.75rem)] w-[clamp(0.65rem,1.5vw,0.75rem)] text-[var(--filelist-btn-text)] sm:h-[clamp(0.75rem,1.8vw,0.875rem)] sm:w-[clamp(0.75rem,1.8vw,0.875rem)]"
                  aria-hidden
                />
              ...
              {selectedCount > 0 && (
                <span className="neu-raised-green trashConsoleSummaryChip trashConsoleSelectedChip flex items-center justify-center leading-none rounded-[clamp(0.35rem,0.8vw,0.5rem)] border-0 px-[clamp(0.42rem,0.9vw,0.62rem)] py-[clamp(0.14rem,0.36vw,0.24rem)] text-[length:var(--font-size-ui-6xs)] font-semibold tracking-[0.12em] text-[var(--filelist-btn-text)] sm:text-[length:var(--font-size-ui-3xs)]">
            ...
            <div
              ...
              className={`trashConsoleActions ${selectedCount > 0 ? "trashConsoleActionsSelected" : ""} flex w-full min-w-0 flex-row flex-wrap items-center justify-between gap-[clamp(0.55rem,1.25vw,0.85rem)] overflow-visible`}
            >
              <div
                data-testid="trash-batch-actions-row"
                className="trashBatchActionsRow flex min-w-0 flex-wrap items-center justify-start gap-[clamp(0.34rem,0.82vw,0.55rem)]"
              >
                <button
                  type="button"
                  ...
                  className="neu-raised-sm toolbarActionBtn trashConsoleButton trashSelectAllButton font-brand inline-flex w-auto max-w-max shrink-0 items-center justify-center py-[clamp(0.0975rem,0.2vw,0.125rem)] gap-[clamp(0.2rem,0.7vw,0.25rem)] px-[clamp(0.3rem,0.8vw,0.375rem)] text-[length:var(--font-size-ui-4xs)] font-normal leading-none tracking-widest text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-45 sm:gap-[clamp(0.3rem,0.8vw,0.375rem)] sm:px-[clamp(0.4rem,1vw,0.5rem)] sm:text-[length:var(--font-size-ui-3xs)]"
                >
                  <CheckSquare
                    className="h-[clamp(0.65rem,1.5vw,0.75rem)] w-[clamp(0.65rem,1.5vw,0.75rem)] sm:h-[clamp(0.75rem,1.8vw,0.875rem)] sm:w-[clamp(0.75rem,1.8vw,0.875rem)]"
                    aria-hidden
                  />
                ...
                <button
                  type="button"
                  onClick={() =>
                    batchRestoreMutation.mutate(visibleSelectedIds)
                  }
                  disabled={
                    selectedCount === 0 || batchRestoreMutation.isPending
                  }
                  className="neu-raised-sm toolbarActionBtn trashConsoleButton trashBatchRestoreButton font-brand inline-flex w-auto max-w-max shrink-0 items-center justify-center gap-[clamp(0.2rem,0.7vw,0.25rem)] px-[clamp(0.3rem,0.8vw,0.375rem)] text-[length:var(--font-size-ui-4xs)] font-normal leading-none tracking-widest text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-45 sm:gap-[clamp(0.3rem,0.8vw,0.375rem)] sm:px-[clamp(0.4rem,1vw,0.5rem)] sm:text-[length:var(--font-size-ui-3xs)]"
                  aria-label="批量还原"
                >
                  <ArchiveRestore
                    className="h-[clamp(0.65rem,1.5vw,0.75rem)] w-[clamp(0.65rem,1.5vw,0.75rem)] sm:h-[clamp(0.75rem,1.8vw,0.875rem)] sm:w-[clamp(0.75rem,1.8vw,0.875rem)]"
                ...
                <button
                  ...
                  disabled={
                    selectedCount === 0 || batchPermanentMutation.isPending
                  }
                  className="neu-raised-sm toolbarActionBtn trashConsoleButton trashBatchPermanentButton font-brand inline-flex w-auto max-w-max shrink-0 items-center justify-center gap-[clamp(0.2rem,0.7vw,0.25rem)] px-[clamp(0.3rem,0.8vw,0.375rem)] text-[length:var(--font-size-ui-4xs)] font-normal leading-none tracking-widest text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-45 sm:gap-[clamp(0.3rem,0.8vw,0.375rem)] sm:px-[clamp(0.4rem,1vw,0.5rem)] sm:text-[length:var(--font-size-ui-3xs)]"
                  aria-label="批量彻底删除"
                >
                  <XCircle
                    className="h-[clamp(0.65rem,1.5vw,0.75rem)] w-[clamp(0.65rem,1.5vw,0.75rem)] sm:h-[clamp(0.75rem,1.8vw,0.875rem)] sm:w-[clamp(0.75rem,1.8vw,0.875rem)]"
              ...
              <div
                ...
                className="trashBaseActionsRow ml-auto flex min-w-0 flex-wrap items-center justify-end gap-[clamp(0.34rem,0.82vw,0.55rem)]"
              >
                <button
                  type="button"
                  onClick={handleBack}
                  className="neu-raised-sm toolbarActionBtn trashConsoleButton trashBackButton font-brand inline-flex w-auto max-w-max shrink-0 items-center justify-center gap-[clamp(0.2rem,0.7vw,0.25rem)] px-[clamp(0.3rem,0.8vw,0.375rem)] text-[length:var(--font-size-ui-4xs)] font-normal leading-none tracking-widest text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] sm:gap-[clamp(0.3rem,0.8vw,0.375rem)] sm:px-[clamp(0.4rem,1vw,0.5rem)] sm:text-[length:var(--font-size-ui-3xs)]"
                  aria-label="返回上一级"
                >
                  <ArrowLeft
                    className="h-[clamp(0.65rem,1.5vw,0.75rem)] w-[clamp(0.65rem,1.5vw,0.75rem)] sm:h-[clamp(0.75rem,1.8vw,0.875rem)] sm:w-[clamp(0.75rem,1.8vw,0.875rem)]"
                ...
                <button
                  ...
                  aria-label="清空回收站"
                  className="neu-raised-sm toolbarActionBtn trashConsoleButton trashEmptyButton font-brand inline-flex w-auto max-w-max shrink-0 items-center justify-center gap-[clamp(0.2rem,0.7vw,0.25rem)] px-[clamp(0.3rem,0.8vw,0.375rem)] text-[length:var(--font-size-ui-4xs)] font-normal leading-none tracking-widest text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-45 sm:gap-[clamp(0.3rem,0.8vw,0.375rem)] sm:px-[clamp(0.4rem,1vw,0.5rem)] sm:text-[length:var(--font-size-ui-3xs)]"
                >
                  <Trash2
                    className="h-[clamp(0.65rem,1.5vw,0.75rem)] w-[clamp(0.65rem,1.5vw,0.75rem)] sm:h-[clamp(0.75rem,1.8vw,0.875rem)] sm:w-[clamp(0.75rem,1.8vw,0.875rem)]"
                    aria-hidden
        ...
        {isLoading ? (
          <div className="neu-inset flex min-h-[clamp(10rem,24vw,12rem)] items-center justify-center rounded-[clamp(0.4rem,1vw,0.5rem)] border-0">
            <Spinner size="lg" />
          </div>
        ) : files.length === 0 ? (
          <EmptyState
            ...
            icon={
              <Trash2
                className="h-[clamp(2rem,4.5vw,2.25rem)] w-[clamp(2rem,4.5vw,2.25rem)] text-[var(--color-text-muted)]"
                aria-hidden
              />
            }
          />
              ...
              {files.map((file) => {
                ...
                return (
                  ...
                  <article
                    ...
                    className={`neu-raised trashCardFrame group relative cursor-pointer rounded-[clamp(0.3rem,0.8vw,0.375rem)] transition-[box-shadow,color] ${isSelected ? "trashCardSelected neu-pressed" : ""}`}
                  >
                    <div className="p-[clamp(0.6rem,1.4vw,0.75rem)]">
                      <div
                        data-testid={`trash-card-thumbnail-${file.id}`}
                        className="neu-inset trashCardThumb relative mb-[clamp(0.6rem,1.4vw,0.75rem)] aspect-square cursor-pointer overflow-hidden rounded-[clamp(0.2rem,0.6vw,0.25rem)] border-0"
                      >
                        <SelectionCheckbox
                      ...
                      >
                        ...
                        >
                          <button
                            ...
                            className="neu-flat-green trashCardActionButton trashCardNeuButton inline-flex min-w-0 flex-1 items-center justify-center text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-60"
                            aria-label={`还原 ${file.original_filename}`}
                            title="Restore"
                          >
                            <ArchiveRestore
                              className="trashCardActionIcon"
                              aria-hidden
                            />
                          </button>
                          <button
                            ...
                            className="neu-flat-red trashCardActionButton trashCardNeuButton inline-flex min-w-0 flex-1 items-center justify-center text-[var(--filelist-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-60"
