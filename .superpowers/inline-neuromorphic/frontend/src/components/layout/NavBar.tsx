...
export default function NavBar({
  ...
  const filesLocation = currentFilesLocation(
    location.pathname,
    location.search,
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="flex min-w-0 items-center gap-[clamp(0.75rem,2vw,1rem)]"
            data-oid="trr68n."
          >
            {backTo && (
              <button
          ...
          >
            ...
            <div
              className={cn(
                "neu-raised-sm nav-panel relative flex shrink-0 items-center overflow-visible",
              )}
            ...
            >
              {username != null && (
                ...
                >
                  <span
                    className="nav-dot bg-emerald-500 shadow-none"
                    data-oid="t.9r114"
                  />
              ...
              <button
                ...
                onClick={() => {
                  const returnTo =
                    filesLocation ?? readTrashReturnTarget() ?? "/files";
