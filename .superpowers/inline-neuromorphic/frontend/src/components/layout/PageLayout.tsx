...
export default function PageLayout({
  ...
  return (
    ...
    >
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:left-[clamp(0.75rem,2vw,1rem)] focus:top-[clamp(0.75rem,2vw,1rem)] focus:z-[100] focus:rounded focus:bg-indigo-500 focus:px-[clamp(0.625rem,1.5vw,0.75rem)] focus:py-[clamp(0.4rem,1vw,0.5rem)] focus:text-[var(--btn-primary-text)] focus:shadow-[var(--neu-control-shadow)]"
      >
        跳转到主内容
      </a>
      <NavBar
