      ...
      >
        ...
        >
          ...
          <div
            ...
            data-oid="7omu0xz"
          >
            <span className="h-px flex-1 bg-slate-500/35" data-oid="xv-bzpc" />

            <span
              className="neu-inset inline-block h-[clamp(0.3rem,0.9vw,0.375rem)] w-[clamp(0.3rem,0.9vw,0.375rem)] rounded-full"
              data-oid="kfl7.dq"
            />

            <span className="h-px flex-1 bg-slate-500/35" data-oid="25ueqhn" />
          </div>
        </div>
      </div>
    </footer>
