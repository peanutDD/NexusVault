...
export default function UrlUploadForm({ onFileAdd }: UrlUploadFormProps) {
  ...
  return (
    ...
    >
      ...
      >
        <SatelliteDish
          className="h-[clamp(0.78rem,1.8vw,1rem)] w-[clamp(0.78rem,1.8vw,1rem)] text-[var(--upload-accent)]"
          aria-hidden="true"
        />
        Or upload from URL
      </p>
      ...
      >
        ...
        <input
          ...
          className={cn(
            "neu-pressed uploadDialogNeuInput uploadUrlInput font-brand min-w-0 flex-1 rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 bg-transparent px-[clamp(0.78rem,1.8vw,1rem)] py-[clamp(0.4875rem,1.125vw,0.625rem)] text-[clamp(0.75rem,1.8vw,0.875rem)] font-normal tracking-widest text-[var(--upload-input-text)] placeholder-[var(--upload-input-placeholder)] transition-[box-shadow,color] focus:outline-none",
            urlInput.trim() ? "uploadDialogNeuInputActive" : "",
          )}
        ...
        <button
          ...
          className="neu-raised-sm uploadDialogNeuPrimaryBtn uploadDialogUrlUploadBtn font-brand inline-flex items-center justify-center gap-[clamp(0.39rem,0.9vw,0.5rem)] rounded-[clamp(0.4rem,1vw,0.5rem)] px-[clamp(1rem,2.25vw,1.25rem)] py-[clamp(0.4875rem,1.125vw,0.625rem)] text-[clamp(0.75rem,1.8vw,0.875rem)] font-normal tracking-widest text-[var(--btn-primary-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)] disabled:cursor-not-allowed disabled:opacity-50"
          data-oid="dp9.vve"
        >
          <Link2
