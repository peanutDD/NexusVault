  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "flex items-center gap-[clamp(0.195rem,0.45vw,0.25rem)] px-[clamp(0.39rem,0.9vw,0.5rem)] py-[clamp(0.195rem,0.45vw,0.25rem)] transition-[box-shadow,color] whitespace-nowrap",
          path.length === 0
      ...
      {path.map((folder, index) => (
        ...
        >
          ...
          <button
            ...
            className={cn(
              "px-[clamp(0.39rem,0.9vw,0.5rem)] py-[clamp(0.195rem,0.45vw,0.25rem)] transition-[box-shadow,color] whitespace-nowrap",
              index === path.length - 1
                ? "text-[var(--filelist-breadcrumb-text-active)]"
                : "text-[var(--filelist-breadcrumb-text-muted)] hover:text-[var(--filelist-breadcrumb-text-active)]",
            )}
