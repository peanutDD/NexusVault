...
describe("FileListPortfolioFireworksBackground", () => {
  ...
  it("keeps the canvas transparent instead of painting a separate background when reduced motion is preferred", () => {
    const addEventListener = vi.spyOn(window, "addEventListener");
    stubMatchMedia(true);
    document.documentElement.style.setProperty("--filelist-fireworks-bg", "rgb(255, 0, 0)");
  ...
  it("uses transparent CodePen fireworks compositing over the current Neuromorphic theme", () => {
    render(<FileListPortfolioFireworksBackground />);
  ...
  it("keeps the canvas transparent when the theme changes away from a fireworks theme", async () => {
    document.documentElement.style.setProperty("--filelist-fireworks-bg", "rgb(255, 0, 0)");
    render(<FileListPortfolioFireworksBackground />);
    const canvas = screen.getByTestId("filelist-portfolio-fireworks-background");
