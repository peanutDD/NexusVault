...
describe("FileListContent", () => {
  ...
  it("maps the empty state to neuromorphic raised and inset primitives", () => {
    ...
    expect(css).toContain(".emptyStateIconShell");
    expect(css).toContain(".emptyStateTitle");
    expect(css).toContain(".emptyStateDescription");
  ...
  it("maps the search status rail to fluid inset neuromorphic primitives", () => {
    ...
    expect(css).toContain(".fileListSearchStatusSurface");
    expect(css).toContain(".fileListSearchStatusShell");
    expect(css).toContain(".fileListSearchStatusWell");
    expect(css).toContain(".fileListSearchStatusRail");
    expect(css).toContain(".fileListSearchStatusChips");
  ...
  it("keeps search status typography compact on mobile", () => {
    ...
    expect(css).toContain(".fileListSearchStatusTitle");
    expect(css).toContain("font-size: var(--font-size-ui-xs)");
    expect(css).toContain(".fileListSearchStatusDescription");
    expect(css).toContain("font-size: var(--font-size-ui-3xs)");
    expect(css).toContain(".fileListSearchStatusCaption");
    expect(css).toContain("font-size: var(--font-size-ui-5xs)");
    expect(css).toContain(".fileListSearchStatusChip");
    expect(css).toContain("font-size: var(--font-size-ui-6xs)");
  });

  it("uses theme-neutral primitives instead of theme-specific file-list skins", () => {
    const source = readFileSync(
      resolve(__dirname, "FileListContent.tsx"),
      "utf8",
    );
    const css = readFileSync(resolve(__dirname, "FileListGlass.css"), "utf8");

    expect(source).toContain("neu-raised fileListSearchStatusSurface");
    expect(source).toContain("neu-inset fileListSearchStatusWell");
    expect(source).toContain("neu-inset fileListSearchStatusRail");
