  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/*<div
            className="pointer-events-none absolute -inset-[clamp(0.78rem,1.8vw,1rem)] rounded-[1.875rem] shadow-[var(--neu-raised-shadow)]"
            data-oid="ch3s5ae"
          />*/}
          <PreviewPedestal />
  ...
  return (
    ...
    >
      {Array.from({ length: 9 }, (_, index) => (
        <div
          key={index}
          className="pointer-events-none absolute inset-0 rounded-[1.625rem] border-0 bg-transparent"
          style={{ transform: `translateZ(calc(var(--t-unit)*-${index + 1}))` }}
          data-oid="27s5zdz"
        />
      ))}
      <div
        className="pointer-events-none absolute inset-0 rounded-[1.625rem] bg-transparent shadow-[var(--neu-inset-shadow)] [transform:translateZ(calc(var(--t-unit)*-10))]"
        data-oid="evrzy6x"
      >
        <div
      ...
      <div
        className="neu-flat relative h-full w-full overflow-hidden border-0 bg-transparent [transform:translateZ(0rem)]"
        data-oid="-z5gcd."
      >
