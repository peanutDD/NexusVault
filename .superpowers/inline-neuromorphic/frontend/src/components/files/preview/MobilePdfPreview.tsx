...
function MobilePdfPreview({ blobUrl, title }: MobilePdfPreviewProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {error && !docLoading && (
          ...
          >
            ...
            >
              <div
                className="neu-inset flex h-[clamp(3.25rem,6.3vw,3.5rem)] w-[clamp(3.25rem,6.3vw,3.5rem)] items-center justify-center rounded-full"
                data-oid="69txr4y"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="neu-raised-sm mobilePdfOpenButton rounded-full px-[clamp(1rem,2.25vw,1.25rem)] py-[clamp(0.39rem,0.9vw,0.5rem)] text-[clamp(0.75rem,1.8vw,0.875rem)] text-[var(--preview-pdf-open-btn-text)] transition-[box-shadow,color] active:shadow-[var(--neu-pressed-shadow)]"
                data-oid="hj9.2ui"
              >
                在新标签中打开
              </a>
      ...
      {numPages > 0 && (
        <div
          className="neu-raised mobilePdfToolbar flex shrink-0 items-center justify-between gap-[clamp(0.39rem,0.9vw,0.5rem)] border-0 px-[clamp(0.585rem,1.35vw,0.75rem)] py-[clamp(0.39rem,0.9vw,0.5rem)]"
          onClick={(e) => e.stopPropagation()}
          data-oid="s1eh5vm"
        >
          {/* 上一页 */}
          <button
            ...
            className="neu-raised-sm mobilePdfToolbarButton flex h-[clamp(2rem,4.05vw,2.25rem)] w-[clamp(2rem,4.05vw,2.25rem)] items-center justify-center rounded-full text-[var(--preview-pdf-btn-text)] transition-[box-shadow,color] disabled:opacity-25 active:shadow-[var(--neu-pressed-shadow)]"
            aria-label="上一页"
            data-oid="ddcus-n"
          >
            <svg
          ...
          <button
            ...
            className="neu-raised-sm mobilePdfToolbarButton flex h-[clamp(1.75rem,3.6vw,2rem)] w-[clamp(1.75rem,3.6vw,2rem)] items-center justify-center rounded-full text-[clamp(1rem,2.4vw,1.125rem)] font-bold text-[var(--preview-pdf-btn-muted)] transition-[box-shadow,color] disabled:opacity-25 active:shadow-[var(--neu-pressed-shadow)]"
            aria-label="缩小"
            data-oid="c841dnq"
          >
            <svg
          ...
          <button
            ...
            className="neu-raised-sm mobilePdfToolbarButton flex h-[clamp(1.75rem,3.6vw,2rem)] w-[clamp(1.75rem,3.6vw,2rem)] items-center justify-center rounded-full text-[var(--preview-pdf-btn-muted)] transition-[box-shadow,color] disabled:opacity-25 active:shadow-[var(--neu-pressed-shadow)]"
            aria-label="放大"
            data-oid="9sco1ge"
          >
            <svg
