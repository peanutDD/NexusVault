    ...
    >
      <div className="space-y-[clamp(0.78rem,1.8vw,1rem)]">
          ...
          >
            {(versions.data?.versions ?? []).map((version) => (
              <div
                ...
                className="neu-raised-sm fileActionDialogRaisedRow mb-[clamp(0.585rem,1.35vw,0.75rem)] rounded-[clamp(0.6rem,1.35vw,0.75rem)] border-0 p-[clamp(0.78rem,1.8vw,1rem)]"
              >
                <div className="flex flex-col gap-[clamp(0.585rem,1.35vw,0.75rem)] sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-[clamp(0.39rem,0.9vw,0.5rem)]">
                    <input
                      ...
                      placeholder="备注"
                      className="neu-inset singleShareDialogField min-w-[var(--app-version-label-min-width)] rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 px-[clamp(0.58rem,1.35vw,0.75rem)] py-[clamp(0.3rem,0.8vw,0.4rem)] text-[var(--dialog-field-text)]"
                    />
                    <button className="neu-raised-sm singleShareDialogAction rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 px-[clamp(0.58rem,1.35vw,0.75rem)] py-[clamp(0.3rem,0.8vw,0.4rem)] text-[var(--dialog-action-text)] active:shadow-[var(--neu-pressed-shadow)]" onClick={() => saveLabel(version)}>
                      Save
                    </button>
                    {version.can_diff && (
                      <button className="neu-raised-sm singleShareDialogAction rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 px-[clamp(0.58rem,1.35vw,0.75rem)] py-[clamp(0.3rem,0.8vw,0.4rem)] text-[var(--dialog-action-text)] active:shadow-[var(--neu-pressed-shadow)]" onClick={() => showDiff(version)}>
                        Diff
                      </button>
                    )}
                    <a className="neu-raised-sm singleShareDialogAction rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 px-[clamp(0.58rem,1.35vw,0.75rem)] py-[clamp(0.3rem,0.8vw,0.4rem)] text-[var(--dialog-action-text)] active:shadow-[var(--neu-pressed-shadow)]" href={fileVersionService.downloadUrl(version.id)}>
                      Download
                    </a>
                    {version.can_preview && (
                      <a className="neu-raised-sm singleShareDialogAction rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 px-[clamp(0.58rem,1.35vw,0.75rem)] py-[clamp(0.3rem,0.8vw,0.4rem)] text-[var(--dialog-action-text)] active:shadow-[var(--neu-pressed-shadow)]" href={fileVersionService.previewUrl(version.id)} target="_blank" rel="noreferrer">
                        Preview
                      </a>
                    )}
                    <button
                      aria-label={`Restore version ${version.version_number}`}
                      className="neu-raised-sm singleShareDialogAction rounded-[clamp(0.4rem,1vw,0.5rem)] border-0 px-[clamp(0.58rem,1.35vw,0.75rem)] py-[clamp(0.3rem,0.8vw,0.4rem)] text-[var(--dialog-action-text)] active:shadow-[var(--neu-pressed-shadow)]"
        ...
        {diffVersion && diff !== null && (
          <pre className="neu-inset fileActionDialogInsetList max-h-[14rem] overflow-auto rounded-[clamp(0.5rem,1.1vw,0.625rem)] p-[clamp(0.78rem,1.8vw,1rem)] text-[clamp(0.68rem,1.6vw,0.75rem)] text-[var(--dialog-panel-text)]">
