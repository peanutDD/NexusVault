      ...
      {!isLoading && storageUsage ? (
        <div className="space-y-[clamp(0.78rem,1.8vw,1rem)]" data-oid="yvquog4">
          <div className="grid gap-[clamp(0.585rem,1.35vw,0.75rem)] sm:grid-cols-2" data-oid="ght-we:">
            <div
              className="neu-pressed rounded-[clamp(0.7rem,1.6vw,0.75rem)] border-0 p-[clamp(0.78rem,1.8vw,1rem)]"
              data-oid="5t21sp4"
            >
              <div
          ...
          {storageUsage.quota !== null &&
            storageUsage.usage_percent !== null && (
              ...
              >
                ...
                <div
                  className="neu-inset mt-[clamp(0.585rem,1.35vw,0.75rem)] h-[clamp(0.585rem,1.35vw,0.75rem)] w-full overflow-hidden rounded-full"
                  data-oid="g8oyzf_"
                >
                  <div
                    ref={progressBarRef}
