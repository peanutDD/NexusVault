...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    <div
      ...
      className={
        isOpen
          ? "neu-raised-sm filtersCard filtersCardOpen"
          : "neu-raised-sm filtersCard"
      }
      data-oid="l.pv-2x"
    >
      <button
      ...
      {isOpen && (
        <div
          ref={menuRef}
          className="neu-raised filtersDropdownPanel text-[clamp(0.68rem,1.4vw,0.75rem)]"
          role="menu"
                ...
                <button
                  ...
                  className={
                    option.value === selectedValue
                      ? "neu-pressed filtersItem filtersItemSelected"
                      : "filtersItem"
                  }
