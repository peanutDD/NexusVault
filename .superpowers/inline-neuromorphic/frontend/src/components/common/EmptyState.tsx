...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        "neu-inset emptyStateSurface flex flex-col items-center justify-center px-[clamp(0.75rem,2vw,1rem)] py-[clamp(3rem,8vw,4rem)] text-center",
        className,
      )}
    ...
    >
      {icon && (
        <div
          className="neu-raised-sm emptyStateIconShell mb-[clamp(0.75rem,2vw,1rem)] flex h-[clamp(4rem,10vw,5rem)] w-[clamp(4rem,10vw,5rem)] items-center justify-center rounded-full"
          data-oid="2z8bf-l"
        >
          {icon}
        </div>
