  ...
  return (
    ...
    >
      {isSelected ? (
        <span
          className={cn(
            "neu-pressed card-checkbox-codepen-box card-checkbox-outer-crystal card-checkbox-selected text-[var(--filelist-check-bg-checked-on)] flex items-center justify-center rounded-full transition-colors duration-150",
            isResponsive
        ...
        >
          <svg
            className={cn(
              "transition-colors duration-150 group-hover:text-[var(--selection-check-icon-hover)]",
              isResponsive
