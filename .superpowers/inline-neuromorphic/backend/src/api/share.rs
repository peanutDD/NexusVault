...
use crate::handlers::share::{
    ...
    download_shared_file_handler, list_share_events_handler, list_shares_handler,
...
pub fn create_router() -> Router<AppState> {
    Router::new()
        ...
        .route("/{id}/events", get(list_share_events_handler))
        .route("/{id}", patch(update_share_handler))
