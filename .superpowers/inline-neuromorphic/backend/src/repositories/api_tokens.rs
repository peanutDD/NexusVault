...
pub struct UpdateApiTokenRecord<'a> {
    ...
    pub async fn update_owned(
        ...
        sqlx::query_as::<_, ApiToken>(
            ...
            SET
                ...
                webdav_enabled = COALESCE($4, webdav_enabled),
                webdav_read_only = COALESCE($5, webdav_read_only),
                webdav_root_folder_id = CASE WHEN $6 THEN $7 ELSE webdav_root_folder_id END,
        ...
        .bind(record.webdav_enabled)
        .bind(record.webdav_read_only)
        .bind(record.webdav_root_folder_id.is_some())
        .bind(record.webdav_root_folder_id.flatten())
        .fetch_optional(self.pool)
        .await
        .map_err(AppError::from)
    }
